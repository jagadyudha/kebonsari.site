...
const Infographics = () => {
  return (
    <section className="xl:px-40 md:px-12 px-6">
      <div className="text-center xl:w-1/2 w-full px-6 mx-auto" id="infografis">
      ...
      <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 xl:py-12 py-6 xl:gap-10 gap-4">
        {Data.map((item) => (
